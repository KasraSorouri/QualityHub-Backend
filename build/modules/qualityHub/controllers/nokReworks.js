...
const nokReworks_1 = __importDefault(require("../services/nokReworks"));
// Get All Reworks
const getAllReworks = (_req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const reworks = yield nokReworks_1.default.getAllReworks();
        res.json(reworks);
    }
    catch (err) {
...
const getRework = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const rework = yield nokReworks_1.default.getRework(Number(id));
        res.json(rework);
    }
    catch (err) {
...
const getReworksByNok = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const nokId = Number(req.params.id);
    if (!nokId) {
        res.status(400).json({ error: 'Invalid product id' });
    }
    try {
        const reworks = yield nokReworks_1.default.getReworksByNok(nokId);
        res.json(reworks);
    }
    catch (err) {
...
const addRework = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const result = yield nokReworks_1.default.createRework(reworkData);
